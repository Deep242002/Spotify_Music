...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("https://t.me/Deepfeelingzone")
                await self.one.join_chat("https://t.me/Deepfeelingzone")
                await self.one.join_chat("https://t.me/Deepfeelingzone")
                await self.one.join_chat("https://t.me/Deepfeelingzone")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("https://t.me/Deepfeelingzone")
                await self.two.join_chat("https://t.me/Deepfeelingzone")
                await self.two.join_chat("https://t.me/Deepfeelingzone")
                await self.two.join_chat("https://t.me/Deepfeelingzone")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("https://t.me/Deepfeelingzone")
                await self.three.join_chat("https://t.me/Deepfeelingzone")
                await self.three.join_chat("https://t.me/Deepfeelingzone")
                await self.three.join_chat("https://t.me/Deepfeelingzone")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("https://t.me/Deepfeelingzone")
                await self.four.join_chat("https://t.me/Deepfeelingzone")
                await self.four.join_chat("https://t.me/Deepfeelingzone")
                await self.four.join_chat("https://t.me/Deepfeelingzone")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("https://t.me/Deepfeelingzone")
                await self.five.join_chat("https://t.me/Deepfeelingzone")
                await self.five.join_chat("https://t.me/Deepfeelingzone")
                await self.five.join_chat("Deep ♥️ Aru")
            except:
                pass
            assistants.append(5)
            try:
